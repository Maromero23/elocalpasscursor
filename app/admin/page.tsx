          ...
          <div className="px-4 py-6 sm:px-0">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow">
                  ...
                  <div className="bg-gray-50 px-5 py-3">
                    <div className="text-sm">
                      <span className="text-blue-600 font-medium">View all sellers →</span>
                    </div>
                  </div>
                </div>
              </Link>

              {/* QR Configuration Card */}
              <Link href="/admin/qr-config" className="block">
                <div className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow">
                  <div className="p-5">
                    <div className="flex items-center">
                      <div className="flex-shrink-0">
                  ...
                  <div className="bg-gray-50 px-5 py-3">
                    <div className="text-sm">
                      <span className="text-green-600 font-medium">Configure 5 QR buttons →</span>
                    </div>
                  </div>
                </div>
              </Link>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg opacity-50">
                ...
                <div className="bg-gray-50 px-5 py-3">
                  <div className="text-sm">
                    <span className="text-gray-400 font-medium">Day 6 Feature</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-green-700">
                    ...
                    <p className="mt-1">
                      🎯 <strong>Day 5:</strong> Building QR Configuration System
                    </p>
                  </div>
                </div>
              </div>
