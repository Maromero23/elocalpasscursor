...
interface LandingPageTemplate {
  ...
  // Guest Configuration
  guestFixedMode: boolean
  defaultGuestCount: number
  
  // Days Configuration
  daysFixedMode: boolean
...
const defaultTemplate: Partial<LandingPageTemplate> = {
  ...
  guestFixedMode: false,
  defaultGuestCount: 2,
  daysFixedMode: false,
  defaultDayCount: 7,
  phoneFieldLabel: 'Phone:',
  phoneFieldPlaceholder: '(OPTIONAL)',
  footerText: '',
  contactEmail: '',
  contactPhone: '',
  contactAddress: ''
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const cleanData = {
        ...
        guestFixedMode: formData.guestFixedMode,
        defaultGuestCount: formData.defaultGuestCount,
        daysFixedMode: formData.daysFixedMode,
        defaultDayCount: formData.defaultDayCount,
        phoneFieldLabel: formData.phoneFieldLabel,
        phoneFieldPlaceholder: formData.phoneFieldPlaceholder,
                  ...
                  <div className="p-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="space-y-6 border-t pt-6">
                        <h4 className="text-lg font-semibold text-gray-800">Gift Configuration</h4>
                        
                        {/* Guest Configuration */}
                        <div className="bg-gray-50 p-4 rounded-lg">
                          <h5 className="text-md font-medium text-gray-700 mb-3">Number of Guests</h5>
                          
                          <div className="flex items-center justify-between mb-3">
                            <span className="text-sm text-gray-600">Fixed Value (Client cannot change)</span>
                            <label className="relative inline-flex items-center cursor-pointer">
                              <input
                                type="checkbox"
                                checked={formData.guestFixedMode || false}
                                onChange={(e) => setFormData({ ...formData, guestFixedMode: e.target.checked })}
                          ...
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                              {formData.guestFixedMode ? 'Default Guest Count' : 'Default Guest Count (when page loads)'}
                            </label>
                            <input
                              type="number"
                              min="1"
                              max="6"
                              value={formData.defaultGuestCount || 2}
                              onChange={(e) => setFormData({ ...formData, defaultGuestCount: parseInt(e.target.value) })}
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                            <p className="text-xs text-gray-500 mt-1">
                              {formData.guestFixedMode 
                                ? 'Client will always get this number of guests' 
                                : 'Client can change this from 1 to 6 guests'
                              }
                            </p>
                          </div>
                        </div>
                        ...
                        {/* Days Configuration */}
                        <div className="bg-gray-50 p-4 rounded-lg">
                          <h5 className="text-md font-medium text-gray-700 mb-3">Number of Days</h5>
                          ...
                          <div className="flex items-center justify-between mb-3">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                              <input
                                type="checkbox"
                                checked={formData.daysFixedMode || false}
                                onChange={(e) => setFormData({ ...formData, daysFixedMode: e.target.checked })}
                                className="sr-only peer"
                              />
                              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                            </label>
                          ...
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                              {formData.daysFixedMode ? 'Default Day Count' : 'Default Day Count (when page loads)'}
                            </label>
                            <input
                              type="number"
                              min="1"
                              max="10"
                              value={formData.defaultDayCount || 7}
                              onChange={(e) => setFormData({ ...formData, defaultDayCount: parseInt(e.target.value) })}
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                            <p className="text-xs text-gray-500 mt-1">
                              {formData.daysFixedMode 
                                ? 'Client will always get this number of days' 
                                : 'Client can change this from 1 to 10 days'
                              }
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-3 border-t pt-4">
                          <h5 className="text-md font-medium text-gray-700">Additional Features</h5>
