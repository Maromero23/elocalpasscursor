...
export async function POST(request: NextRequest) {
  try {
    ...
    const { rebuyConfig, generatedHTML, action, templateName } = body

    if (action === 'saveTemplate') {
      console.log('🔧 REBUY TEMPLATE API: Saving named template to database')
      
      // Use the HTML generated by the UI (with all enhanced components)
      let customHTML = generatedHTML
...
<body>
    <div class="container">
        ...
        console.log('✅ Using UI-generated HTML with all enhanced components')
        console.log(`   HTML Length: ${customHTML.length} characters`)
        console.log(`   Contains video: ${customHTML.includes('🎥 Promotional Video')}`)
        console.log(`   Contains partners: ${customHTML.includes('featured-partners')}`)
        console.log(`   Contains banners: ${customHTML.includes('banner-images')}`)
      }
