...
INSERT INTO "new_QRConfig" ("allowCustomGuestsDays", "createdAt", "defaultDays", "defaultGuests", "fixedPrice", "id", "landingPageRequired", "pricingType", "sellerId", "sendMethod", "sendRebuyEmail", "updatedAt") SELECT "allowCustomGuestsDays", "createdAt", "defaultDays", "defaultGuests", "fixedPrice", "id", "landingPageRequired", "pricingType", "sellerId", "sendMethod", "sendRebuyEmail", "updatedAt" FROM "QRConfig";
DROP TABLE "QRConfig";
